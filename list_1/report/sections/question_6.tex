...
%
It has over 18,000 active 60$\times$60$\times$7 m cells, 
...
Producer wells are indicated in green, and injectors, in blue.
% 
Given the arrangement of wells, 
oil is pushed towards producers as the injectors fill the reservoir with water.
%
\newpage
\begin{figure}[hb]
    \centering
    \caption{
        Permeabilities of the Egg model realizations used, log scale.
        The redder the cell, the greater its permeability.
    }
    ...
    \begin{subfigure}{.16\textwidth}
        \centering 
        \caption{EGG9}
        \includegraphics[width=\linewidth]{EGG9.jpeg}
    \end{subfigure}
    \begin{subfigure}{.16\textwidth}
        \centering 
        \caption{EGG10}
        \includegraphics[width=\linewidth]{EGG10.jpeg}
    \end{subfigure}
    \begin{subfigure}{.16\textwidth}
        \centering 
        \caption{EGG11}
        \includegraphics[width=\linewidth]{EGG11.jpeg}
    \end{subfigure}
\end{figure}
...
\begin{wrapfigure}{r}{7cm}
    ...
    \label{fig:OPRs}
    \includegraphics[width=\linewidth]{../../python_code/results/multivariate_linear_regression/oil_production_rates.pdf}
\end{wrapfigure}
