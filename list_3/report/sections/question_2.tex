...
\noindent\textbf{Dataset description.}
    ...
    \begin{table}[hbp]
        ...
        \caption{
            ...
            Randomizer seed was fixed at 242104677.}
        \label{tab:data_ppmi}
    ...
    \begin{figure}[h!]
        ...
        \includegraphics[width=15cm]{../../python_code/plots/original_correlations_meta_data.11192021.pdf}
    \end{figure}
...
\begin{table}[!h]
    ...
    \begin{tabular}{ccc}
        ...
        \midrule
            Dropout rate & $[0, 0.5]$ & 12.73\% \\
            Hidden layers' activation function & ReLU$^*$ or sigmoid & sigmoid \\
            Hiddden layers' width & $\{1, 2, \dots, 8\}$ & 8 \\
            Number of hidden layers & $\{1, 2, \dots, 8\}$ & 2 \\
            Learning rate$^{**}$ & $[10^{-4}, 10^{-2}]$ & $2.18 \times 10^{-4}$\\
        \bottomrule
    \end{tabular}
    \begin{tablenotes}
...
The FNN with smallest validation error, 29.67\%, has the parameters presented in \cref{tab:hparams_fnn}'s right column.
...
all neural networks considered also had batch normalization between layers.

\begin{figure}[hb]
    \centering
    \caption{FNN with smallest validation error after 100 trials.}
    \label{fig:fnn}
    \includegraphics[width=5cm]{../../python_code/plots/fnn/best_model.pdf}
\end{figure}
...
%
The best DT with smallest validation error, 30.69\%, has the parameters presented in \cref{tab:hparams_dt}.
...
\begin{table}[!h]
    ...
    \begin{tabular}{ccc}
        \toprule
            Hyperparameter & Possible values & Best after 100 trials \\
        \midrule
            Criterion & Entropy, Gini, or Log-loss & Log-loss \\
            Maximum depth & $\{2, 3, \dots, 20\}$ & 7\\
        \bottomrule
    \end{tabular}
\end{table}
%
\begin{figure}[hb]
    ...
    \label{fig:dt}
    \includegraphics[width=\linewidth]{../../python_code/plots/dt/best_model.pdf}
\end{figure}
...
\begin{figure}[!ht]
    ...
    \begin{subfigure}{.49\textwidth}
        \centering
        \includegraphics[width=\linewidth]{../../python_code/plots/dt/confusion_matrix.pdf}
    \end{subfigure}
\end{figure}